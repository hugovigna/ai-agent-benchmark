...
\begin{tabular}{cll}
  ...
  7 & Debugging (4 bugs)                & \code{challenge/debugging} \\
  \bottomrule
\end{tabular}
\end{center}
...
validate_challenge8.py    Validator challenge 7 (debugging)
...
Utilisé dans : challenge 7 (debugging).
...
% ------------------------------------------------------------------------------
\subsection{Challenge 7 — Debugging (4 bugs)}
...
\textbf{Score partiel sur challenge 5 (Rétrodocumentation)} $\to$ normal, le nombre de checks est
